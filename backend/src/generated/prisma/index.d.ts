...
export namespace Prisma {
  ...
  */
  ...
  export interface Prisma__FolderClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    ...
    prompts<T extends Folder$promptsArgs<ExtArgs> = {}>(args?: Subset<T, Folder$promptsArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$PromptPayload<ExtArgs>, T, "findMany"> | Null>
    /**
  ...
  export interface Prisma__PromptClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    folder<T extends Prompt$folderArgs<ExtArgs> = {}>(args?: Subset<T, Prompt$folderArgs<ExtArgs>>): Prisma__FolderClient<$Result.GetResult<Prisma.$FolderPayload<ExtArgs>, T, "findUniqueOrThrow"> | null, null, ExtArgs>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface PromptFieldRefs {
    ...
    readonly emoji: FieldRef<"Prompt", 'String'>
  ...
  export type PromptWhereInput = {
    ...
    emoji?: StringNullableFilter<"Prompt"> | string | null
  ...
  export type PromptScalarWhereWithAggregatesInput = {
    ...
    emoji?: StringNullableWithAggregatesFilter<"Prompt"> | string | null
